...
* The original package name 'com.java-22.example' is invalid and this project uses 'com.java_22.example' instead.
...
```
$ docker run --rm -p 8080:8080 example:0.0.1-SNAPSHOT
```
